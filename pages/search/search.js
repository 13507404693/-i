...
Page({
  ...
  onLoad: function (options) {
    ...
    this.setData({location: wx.getStorageSync("location")});
  },
  /**
   * 生命周期函数--监听页面显示
   */
  onShow: function () {
    this.setData({
      searchHistory: wx.getStorageSync('searchHistoryTradingArea')
    });
  },
  /**
   * 监听 搜索框 变化
  ...
  updatedHistory() {
    ...
    wx.setStorageSync('searchHistoryTradingArea', searchHistory);
  },
